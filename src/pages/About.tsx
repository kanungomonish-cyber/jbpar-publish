          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div>
              ...
              <p className="text-lg leading-relaxed mb-8">
                ...
                practice-oriented, and multidisciplinary research. Areas of interest include, <span className="relative inline-block px-3 py-1 font-bold text-primary animate-glow rounded-md bg-accent/10 border-2 border-accent/30">but are not limited to:</span>
              </p>
